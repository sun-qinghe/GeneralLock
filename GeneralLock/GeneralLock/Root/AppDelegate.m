...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MSMainController *mainVC = [[MSMainController alloc] init];
    BasicNavigationController *mainNVC = [[BasicNavigationController alloc] initWithRootViewController:mainVC];
