...
@implementation MSTipController
...
//        if (![self.baseView pointInside:[self.baseView convertPoint:location fromView:self.baseView.window] withEvent:nil]){
//            [self.baseView.window removeGestureRecognizer:sender];
//            [self dismissViewControllerAnimated:NO completion:nil];
//        }
        [self closeTipView];
    }
